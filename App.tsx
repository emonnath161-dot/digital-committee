...
// Utils & Types
import { User, School, Update, Message, GalleryImage, Transaction } from './types';
...
const App: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setConnectionError("ডাটাবেজ কানেকশনে সমস্যা হয়েছে।");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-indigo-950 text-white">
        ...
        <h2 className="text-2xl font-black animate-pulse tracking-widest text-center px-4">সিস্টেম লোড হচ্ছে...</h2>
      </div>
    );
  }
